            ...
            <div class="row">
                <div class="col-sm-12">
                   ...
                   if (isset($_GET['men'])&&$_GET['men']=='2') {
                       echo '<div class="alert alert-danger"><ul>';
                       echo '<li>Error al actualizar el plugins</li>';
                       echo '</ul></div>';
        ...
        if (!isset($updater->updates)) {
            ...
            foreach ($updater->check_for_plugin_updates() as $plug) {
                if ($plug['depago']) {
                    ...
                    ?>
                    <form action="<?= $updater->urlserv ?>/index.php?page=editar_plugin&idpluginact=<?php echo $plug['idpluginact'] . '&name=' . $plug['name'].'"'; ?> method="post" class="form" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <input type="file" id="archivokey" name="archivokey" class="form-control">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
