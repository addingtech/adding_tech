...
class admin_info extends fs_controller
{
    ...
    protected function private_core()
    {
        ...
        if (isset($_GET['fix'])) {
            ...
            $this->new_advice('Nunca se ha ejecutado el cron. Te perderás algunas características interesantes de FacturaScripts. Pide información al administrador de tu sistema.');
