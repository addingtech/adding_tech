...
<div class="well">
    <div class="page-header" style="margin-top: 0px;">
        <h1>
            Bienvenido al asistente de intsalación 
            <small><?php echo $fsc->version();?></small>
        </h1>
    </div>
    <p class="help-block">
        Ya tienes instalado el núcleo. El núcleo permite gestionar páginas,
...
<div class="well">
    ...
    <p class="help-block">
        ...
        En la pestaña <b>Panel de control</b> tienes disponibles los plugins instalados.
        Elige los que necesites y actívalo. 
        <br>
        El plugin <b>facturacion_base </b> es el mínimo necesario para trabajar. Actívalo ahora!!!.
    </p>
                ...
                <table class="table table-hover">
                    ...
                    <tr<?php echo $tr_class;?>>
                        ...
                        <td>
                            ...
                            <a href="https://help.soft.finance/plugin/<?php echo $value1['name'];?>" target="_blank" class="btn btn-xs btn-default">
