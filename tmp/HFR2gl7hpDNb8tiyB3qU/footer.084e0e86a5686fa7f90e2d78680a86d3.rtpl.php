      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="page-header">
               ...
               <p class="help-block">
                  Esta demo sirve para tener una idea rápida de cómo funciona nuestro software,
      ...
      <div class="row">
         ...
         <div class="col-sm-6">
            ...
            <ul>
               ...
               <li>Soporte profesional a tu disposición.</li>
            </ul>
         </div>
         <div class="col-sm-3">
   ...
   <div class="container-fluid hidden-print" style="margin-bottom: 10px;">
      ...
      <div class="row">
         <div class="col-sm-4 col-xs-6">
            <small>
               Motor del software: FacturaScripts</a>.
            </small>
         </div>
